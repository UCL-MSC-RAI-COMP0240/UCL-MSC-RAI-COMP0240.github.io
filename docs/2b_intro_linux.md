...
2. Borrowing and booting from an Ubuntu 22.04 installed USB-C NVME Drive 
    ...
    - Different brands of computers have different ways of getting into bios. For example, for dell computer, you could access the BIOS/UEFI settings by restarting your computer and pressing the F2 key repeatedly as soon as the Dell logo appears. ![dell booting configuration](images/Image.jpeg)
